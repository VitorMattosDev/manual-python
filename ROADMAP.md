...
- [ ] **cap 008** - Objetos, variáveis e o modelo de referências - `vol02/cap008-objetos-variaveis-e-o-modelo-de-referencias.qmd`
- [ ] **cap 009** - Números inteiros, de ponto flutuante e complexos - `vol02/cap009-numeros-inteiros-de-ponto-flutuante-e.qmd`
...
- [ ] **cap 015** - Condicionais: if, elif, else e a expressão condicional - `vol03/cap015-condicionais-if-elif-else-e-a-expressao.qmd`
...
- [ ] **cap 022** - Listas: operações, mutabilidade e cópia - `vol04/cap022-listas-operacoes-mutabilidade-e-copia.qmd`
- [ ] **cap 023** - Tuplas, empacotamento e desempacotamento - `vol04/cap023-tuplas-empacotamento-e-desempacotamento.qmd`
...
- [ ] **cap 035** - Leitura e escrita de arquivos de texto - `vol06/cap035-leitura-e-escrita-de-arquivos-de-texto.qmd`
...
- [ ] **cap 041** - Classes, instâncias e o self - `vol07/cap041-classes-instancias-e-o-self.qmd`
...
- [ ] **cap 055** - os, sys e a interação com o sistema - `vol09/cap055-os-sys-e-a-interacao-com-o-sistema.qmd`
...
- [ ] **cap 065** - SQLite e a DB-API: banco de dados sem servidor - `vol10/cap065-sqlite-e-a-db-api-banco-de-dados-sem-servidor.qmd`
...
- [ ] **cap 071** - Parametrização, dublês de teste e cobertura - `vol11/cap071-parametrizacao-dubles-de-teste-e-cobertura.qmd`
