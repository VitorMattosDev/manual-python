...
- [x] **cap 091** - Autenticação, autorização e segurança em aplicações Python - `vol14/cap091-autenticacao-autorizacao-e-seguranca-em.qmd`
- [x] **cap 092** - Implantação: contêineres, servidores de aplicação e produção - `vol14/cap092-implantacao-conteineres-servidores-de.qmd`
...
- [x] **cap 095** - Multiprocessing e o paralelismo real - `vol15/cap095-multiprocessing-e-o-paralelismo-real.qmd`
- [x] **cap 096** - Programação assíncrona: async, await e asyncio - `vol15/cap096-programacao-assincrona-async-await-e-asyncio.qmd`
- [x] **cap 097** - Medindo desempenho: timeit, profiling e otimização - `vol15/cap097-medindo-desempenho-timeit-profiling-e.qmd`
- [x] **cap 098** - Memória, contagem de referências e o coletor de lixo - `vol15/cap098-memoria-contagem-de-referencias-e-o-coletor.qmd`
...
**Total:** 104 capitulos em 16 volumes (102 concluidos).
